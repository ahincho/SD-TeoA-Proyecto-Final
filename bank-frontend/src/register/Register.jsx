				...
				<div class="col-lg-10 col-xl-9 mx-auto">
					<div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
						...
						<div class="card-body p-4 p-sm-5">
							<h5 class="card-title text-center mb-5 fw-light fs-5"><strong>Register</strong></h5>
							<form>
								...
								<div class="form-floating mb-3">
									<input type="text" class="form-control" id="floatingDocument" placeholder="Document" />
									<label for="floatingDocument">Document</label>
								</div>
								<div class="form-floating mb-3">
								...
								<a class="d-block text-center mt-2 small" href="/sign">Have an account? Sign In</a>
								<hr class="my-4" />
								<div class="d-grid mb-2">
